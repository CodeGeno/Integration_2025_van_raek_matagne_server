...
from ue_management.views import AcademicUEListView, \
    AcademicUEDetailView, GenerateNextYearUEsView, LessonListView, LessonDetailView, ResultListView, ResultDetailView, \
    AcademicUEGetById
